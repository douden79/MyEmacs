...
(defvar knuth-packages
  '( auto-complete auto-yasnippet css-mode markdown-mode+ expand-region ecb git-commit-mode gitconfig-mode gitignore-mode helm-gtags diminish rainbow-mode smartparens auctex 
     magit volatile-highlights solarized-theme mouse+ multi-term metaweblog xml-rpc org org2blog tabbar-ruler sr-speedbar  )
